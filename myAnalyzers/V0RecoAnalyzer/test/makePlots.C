...
ntuple->Project("ksCtauLoc", "v0Lifetime", 
		"v0Lifetime > 0. && v0pT < 1.5 && abs(v0CandMass - 0.498) < 0.01 && nTracks < 150 && priVtxChi2 > 0.");
ksLifetimeBG = new TH1F("ksCtauBG", "K^{0}_{S} c#tau background",
			ksLifetimeNbins, ksLifetimeXmin, ksLifetimeXmax);
ksLifetimeBG->Sumw2();
ntuple->Project("ksCtauBG", "v0Lifetime",
		"v0Lifetime > 0. && v0pT < 1.5 && abs(v0CandMass - (0.498 - 0.04)) < 0.01 || abs(v0CandMass - (0.498 + 0.04)) < 0.01 && nTracks < 150 && priVtxChi2 > 0.");
...
ksMassTunable2 = new TH1F("ksMassTunable2", "K^{0}_{S} mass",
			 ksMassNbins, ksMassXmin, ksMassXmax);
ntuple->Project("ksMassTunable", "v0CandMass", "nTracks < 150 && priVtxChi2 > 0.");
...
ntuple->Project("lamMassTunable", "v0CandMass", "nTracks <= 150. && priVtxChi2 > 0.");
