...
config.General.requestName = 'OOTmultiplicity_minbias_run2012C_v7'
...
config.Data.inputDataset = '/MinimumBias/Run2012C-22Jan2013-v1/RECO'
#config.Data.inputDataset = '/MinimumBias/Run2011A-12Oct2013-v1/RECO'
