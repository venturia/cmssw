...
process.load("DebugTools.OverlapProblem.poolSource_cff")
...
process.load("DebugTools.OverlapProblem.tkAlTrackRefitSequence_cff")
process.refittedTracks.src = cms.InputTag("generalTracks")

process.load("DebugTools.OverlapProblem.overlapproblemtsosanalyzer_cfi")
...
process.load("DebugTools.OverlapProblem.overlapproblemtpanalyzer_cfi")
