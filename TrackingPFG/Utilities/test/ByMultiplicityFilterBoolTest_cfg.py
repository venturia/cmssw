...
process.pixelvsstripfilter1.taggedMode=cms.untracked.bool(True)                                                                 
process.pixelvsstripfilter1.forcedValue=cms.untracked.bool(True)                                                                 

process.boolanalpixelvsstripfilter1 = cms.EDAnalyzer("BoolAnalyzer",src=cms.InputTag("pixelvsstripfilter1"))
...
process.logErrorTooManySeeds.forcedValue=cms.untracked.bool(True)                                                                 

process.boolanallogErrorTooManySeeds = cms.EDAnalyzer("BoolAnalyzer",src=cms.InputTag("logErrorTooManySeeds"))

#-------------------------------------------------------------------------------------------

process.seqProducers = cms.Sequence(process.seqMultProd)

#process.p0 = cms.Path(~process.pixelvsstripfilter1 + process.boolanalpixelvsstripfilter1)
#process.p0 = cms.Path(process.pixelvsstripfilter1 + process.boolanalpixelvsstripfilter1)

process.p0 = cms.Path(~process.logErrorTooManySeeds + process.boolanallogErrorTooManySeeds)
#process.p0 = cms.Path(process.logErrorTooManySeeds + process.boolanallogErrorTooManySeeds)
...
process.TFileService = cms.Service('TFileService',
                                   fileName = cms.string('ByMultiplicityFilterBoolTest.root')
