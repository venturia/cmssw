...
pixelVerticesAdaptiveMD = cms.EDProducer("PrimaryVertexProducer",
    ...
    TkFilterParameters = cms.PSet(
        ...
        minPt = cms.double(0.1), ## better for softish events
    ...
    useBeamConstraint = cms.bool(False),  # default for long term data and MC prod
	...
	trackCompatibilityToSVcut = cms.double(0.01), ## 1%
        ...
        maxNbOfVertices = cms.int32(1) ## search all vertices in each cluster
