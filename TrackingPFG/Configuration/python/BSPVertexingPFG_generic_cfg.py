...
process = cms.Process("BSPVertexingPFG")
...
if options.isAOD == 1: 
   process.load("TrackingPFG.Configuration.dataBSPVAnalysisAODPaths_cff")
else: 
   process.load("TrackingPFG.Configuration.dataBSPVAnalysisPaths_cff")
...
process.GlobalTag.toGet = cms.VPSet(
   cms.PSet(record = cms.string("BeamSpotObjectsRcd"),
            tag = cms.string("BeamSpotObjects_2009_LumiBased_SigmaZ_v18_offline"),
...
process.TFileService = cms.Service('TFileService',
                                   fileName = cms.string('BSPVertexing_PFG.root')
                                   )
