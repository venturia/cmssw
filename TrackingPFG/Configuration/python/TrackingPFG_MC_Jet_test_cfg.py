...
process.GlobalTag.toGet = cms.VPSet(
   cms.PSet(record = cms.string("BeamSpotObjectsRcd"),
            tag = cms.string("Realistic7TeVCollisions_START39_V6_mc"),
            connect = 
cms.untracked.string("sqlite_file:/afs/cern.ch/user/c/cerminar/public/Alca/BeamSpot/Realistic7TeVCollisions_START39_V6_mc@1ce156f2-0865-11e0-b661-003048673256.db")
           )
)
