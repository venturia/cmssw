...
| Layer | 20 | 0xF | 4 | pxbLayer(id) or layer(id) | increasing r |
| Ladder | 12 | 0xFF | 8 | pxbLadder(id) | increasing phi |
| Module | 2 | 0x3FF | 10 | pxbModule(id) | increasing z. In the outer tracker modules in the same pt module are sorted by increasing r |
| _not used_ | 0 | 0x3 | 2 | | |
...
| subdetector part | 23 | 0x3 | 2 | pxfSide(id) or side(id) | 1=FPIX- 2=FPIX+ |
| _not used_ | 22 | 0x1 | 1 | | |
| Disk | 18 | 0xF | 4 | pxfDisk(id) or layer(id) | inner pixel before outer tracker, then increasing abs(z) |
| _Blade_ | 12 | 0x3F | 6 | pxfBlade(id) | increasing phi and r: first inner ring blades and the outer ring blades; outer tracker: "blade" is used for the ring (increasing r)  |
| Panel | 10 | 0x3 | 2 | pxbPanel(id) | inner pixel: 1=forward 2=backward; outer tracker: always = 1 |
| Module | 2 | 0xFF | 8 | _pxbModule(id)_ | inner pixel: always = 1; outer tracker: increasing phi and modules in the same pt module are sorted by increasing abs(z) |
| _not used_ | 0 | 0x3 | 2 | | |
